...
let rec code_gen_function lst env si file =
    match lst with
    | [] -> ()
    | Return(e)::t ->
        parse_expr e env file;
        fprintf file "\tld e,a\n\tld h,b\n\tld l,c\n\tld sp,hl\n\tpop bc\n\tret\n";
        code_gen_function t env si file
    | Declare(x, e_opt)::t ->
        ...
        | Some (e) ->
            parse_expr e env file;
            fprintf file "\tld l,a\n\tpush hl\n";);
        code_gen_function t ((x, si)::env) (si - 2) file
    | Expr(e)::t ->
        parse_expr e env file;
        code_gen_function t env si file
